...
constructor(
    ...
    // DELETED because their an already defined repository provided in application
//    companion object {
//        @Volatile
...
//                ).build()
//                DefaultTasksRepository(TasksLocalDataSource(database.taskDao()), TasksRemoteDataSource).also {
//                    INSTANCE = it
//                }
//            }
//        }
